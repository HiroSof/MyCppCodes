...
bool CHSMazeGenerator::SetWallNumber ( int NewWallNumber ) {
	if ( NewWallNumber == AisleNumber ) return false;
...
bool CHSMazeGenerator::SetAisleNumber ( int NewAisleNumber ) {

	if ( NewAisleNumber == WallNumber ) return false;
